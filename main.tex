...
\JHPSissue{2}   % keep 0 until the issue is assigned
...
\JHPSauthor{Julian Kunkel}{Georg-August-Universität Göttingen\\ Göttingen, Germany}{https://hps.vi4io.org/about/people/julian_kunkel}{}
\JHPSauthor{Eugen Betke}{ECMWF\\Reading, UK}{}{eugen.betke@ecmwf.int}   % use empty email here
...
\begin{itemize}
  ...
  \item Job-M: a typical MPI parallel 8-hour compute job on 128 nodes that write time series data after some spin up.   %CHE.ws12
